...
class LocationProvider extends ChangeNotifier {
  ...
  Future<GetWeather> getWeatherData(
      {required double currentLatitude,
      required double currentLongitude}) async {
    final response = await http.get(Uri.parse(
        "https://api.openweathermap.org/data/2.5/forecast/daily?lat=$currentLatitude&lon=$currentLongitude&appid=542ffd081e67f4512b705f89d2a611b2&cnt=5"));
  ...
  Future getCityWeather(String cityName) async {
    final response = await http.get(Uri.parse(
        "https://api.openweathermap.org/data/2.5/forecast/daily?q=$cityName&cnt=5&appid=542ffd081e67f4512b705f89d2a611b2"));
    print(response.body);
